#
# Be sure to run `pod lib lint CMRouter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CMRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CMRouter.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
 ...
 URL router for iOS
  ...
  s.source_files = 'CMRouter/Classes/**/*'
  
  # s.resource_bundles = {
  #   'CMRouter' => ['CMRouter/Assets/*.png']
  # }
